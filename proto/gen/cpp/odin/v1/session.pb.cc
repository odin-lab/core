...
const char descriptor_table_protodef_odin_2fv1_2fsession_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\001\022\n\n\006FAILED\020\002\022\020\n\014DISCONNECTED\020\003*L\n\nModul"
    "eType\022\007\n\003STT\020\000\022\007\n\003TTS\020\001\022\t\n\005AGENT\020\002\022\010\n\004TU"
    "RN\020\003\022\014\n\010RECORDER\020\004\022\t\n\005STATE\020\005BX\n\013com.odi"
    "n.v1B\014SessionProtoP\001\242\002\003OXX\252\002\007Odin.V1\312\002\007O"
    "din\\V1\342\002\023Odin\\V1\\GPBMetadata\352\002\010Odin::V1b"
    "\006proto3"
};
  ...
  if ((cached_has_bits & 0x0000007fu) != 0) {
    ...
    if ((cached_has_bits & 0x00000010u) != 0) {
      if (!from._internal_config_schema().empty()) {
        ...
        if (_this->_impl_.config_schema_.IsDefault()) {
          _this->_internal_set_config_schema("");
        }
      }
    }
    if ((cached_has_bits & 0x00000020u) != 0) {
...
ModuleHeartbeat::_table_ = {
  {
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // .odin.v1.ModuleStatus status = 4 [json_name = "status"];
    {PROTOBUF_FIELD_OFFSET(ModuleHeartbeat, _impl_.status_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // int32 active_sessions = 5 [json_name = "activeSessions"];
    {PROTOBUF_FIELD_OFFSET(ModuleHeartbeat, _impl_.active_sessions_), _Internal::kHasBitsOffset + 3, 0,
