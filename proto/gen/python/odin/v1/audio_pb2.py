...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 29, 3, "", "odin/v1/audio.proto"
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_AUDIOBUFFERMIC"]._serialized_options = (
        b"\242\265\030&audio.{session_id}.{module_name}.input"
    )
    _globals["_AUDIOBUFFERSPEAKER"]._loaded_options = None
    _globals["_AUDIOBUFFERSPEAKER"]._serialized_options = (
        b"\242\265\030'audio.{session_id}.{module_name}.output"
    )
    _globals["_AUDIOBUFFERSESSION"]._loaded_options = None
    _globals["_AUDIOBUFFERSESSION"]._serialized_options = (
        b"\242\265\030*audio.{session_id}.{module_name}.{channel}"
    )
