...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_AUDIOBUFFERMIC']._serialized_options = b'\212\265\030&audio.{session_id}.{instance_id}.input'
  _globals['_AUDIOBUFFERSPEAKER']._loaded_options = None
  _globals['_AUDIOBUFFERSPEAKER']._serialized_options = b'\212\265\030\'audio.{session_id}.{instance_id}.output'
